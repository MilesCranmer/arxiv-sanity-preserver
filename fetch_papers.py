...
if __name__ == "__main__":
  ...
  parser.add_argument('--search-query', type=str,
                      default='cat:astro-ph.GA+OR+cat:astro-ph.CO+OR+cat:astro-ph.EP+OR+cat:astro-ph.GA+OR+cat:astro-ph.HE+OR+cat:astro-ph.IM+OR+cat:astro-ph.SR+OR+cat:astro-ph.HE',
